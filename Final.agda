...
{- Suffix xs ys means that xs is a suffix of ys -}
  ...
  cancel kelvin gram = {!!}
  cancel kelvin gram- = {!!}
  cancel kelvin second = {!!}
  cancel kelvin second- = {!!}
  cancel kelvin ampere = {!!}
  cancel kelvin ampere- = {!!}
  cancel kelvin kelvin = {!!}
  cancel kelvin kelvin- = {!!}
  cancel kelvin candela = {!!}
  cancel kelvin candela- = {!!}
  cancel kelvin mol = {!!}
  cancel kelvin mol- = {!!}
  cancel kelvin (y u× y₁) = {!!}
  ...
  cancel kelvin- (y u× y₁) = {!!}
  cancel candela noU = {!!}
  cancel candela meter = {!!}
  cancel candela meter- = {!!}
  cancel candela gram = {!!}
  cancel candela gram- = {!!}
  cancel candela second = {!!}
  cancel candela second- = {!!}
  cancel candela ampere = {!!}
  cancel candela ampere- = {!!}
  cancel candela kelvin = {!!}
  cancel candela kelvin- = {!!}
  cancel candela candela = {!!}
  cancel candela candela- = {!!}
  cancel candela mol = {!!}
  cancel candela mol- = {!!}
  cancel candela (y u× y₁) = {!!}
  cancel candela- noU = {!!}
  cancel candela- meter = {!!}
  cancel candela- meter- = {!!}
  cancel candela- gram = {!!}
